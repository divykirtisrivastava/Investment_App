...
import t7 from '../../public/t7.webp'
import t8 from '../../public/t8.jpg'
import t9 from '../../public/t9.jpg'
import t10 from '../../public/t10.jpeg'
import t11 from '../../public/t10.jpg'
import t12 from '../../public/t11.jpg'
  ...
  const data = [
    ...
    },
    {
      ...
      content: (
        <div>
          <p className="text-neutral-800 dark:text-neutral-200 text-xs md:text-sm font-normal mb-8">
          At Filixo, our journey in the world of trading has been marked by innovation, growth, and a commitment to excellence.
          </p>
          <p className="text-neutral-800 dark:text-neutral-200 text-xs md:text-sm font-normal mb-8">
          Our company was established with a vision to make trading accessible to everyone, combining cutting-edge technology with industry expertise.
          </p>
          <div className="grid grid-cols-2 gap-4">
            <Image
              src={t5}
