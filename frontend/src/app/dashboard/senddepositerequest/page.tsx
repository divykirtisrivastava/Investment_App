...
const senddepositerequest = () => {
    ...
    const handleImage = (e: React.ChangeEvent<HTMLInputElement | any>) => {
        ...
        if (files) {
            setDepositeData((prev: any) => ({ ...prev, transactionImage: files[0] }));
        }
    };
...
function handleinpchange(e:any){
    ...
    return (
        <div className="flex justify-center items-center min-h-screen background-color border rounded-xl p-4">
            {flag ? <div className="background-color border  text-white p-8 rounded-lg shadow-lg w-full max-w-2xl">
                ...
                <div className="bg-gray-700 p-6 rounded mb-4 w-full">
                    <div className='w-full flex gap-3'>
                        <div className='w-1/2 border-white border-2 rounded-lg py-2 px-4'>
                        ...
                        <div className='w-1/2 border-white border-2 rounded-lg py-2 px-4'>
                            ...
                            <div className='w-full h-10  bg-gray-200 rounded-lg flex items-center text-black text-xl font-bold justify-between overflow-hidden border'>
                                <p className='pl-1'>{textToCopy}</p>
                                <button onClick={handleCopy} className='background-color p-5 rounded-lg text-white cursor-pointer'>Copy</button>
                            </div>
                        </div>
                    </div>
                    <div className="my-4">
